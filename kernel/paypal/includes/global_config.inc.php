...
?>
        ...
        <input type="hidden" name="notify_url" value="<?php echo "http://www.geracaoconsciente.pt/kernel/".$paypal['notify_url']; ?>" />
        ...
        <input type="hidden" name="custom_field" value="<?php echo $paypal['custom_field']?>" />
        <input type="hidden" name="custom" value="<?php echo $paypal['custom']?>" />

        <!-- Product Information -->
        <input type="hidden" name="num_cart_items" value="<?php echo $paypal['num_cart_items']?>" />

        <?php for($i=1;$i<=$_POST['num_cart_items'];$i++){ ?>
            <input type="hidden" name="item_number_<?php echo $i; ?>" value="<?php echo $paypal['item_number'.$i]?>" />
            <input type="hidden" name="item_name_<?php echo $i; ?>" value="<?php echo $paypal['item_name'.$i]?>" />
            <input type="hidden" name="amount_<?php echo $i; ?>" value="<?php echo $paypal['amount'.$i]?>" />
            <input type="hidden" name="quantity_<?php echo $i; ?>" value="<?php echo $paypal['quantity'.$i]?>" />
            <input type="hidden" name="tax_<?php echo $i; ?>" value="0.0" />
        <?php } ?>
